//Wap to input 10 integer value in an array num [] and 
// 10 double type values in another array dou[] . 
// store the average of the corresponding values of both the arrays in avg[ ] .
